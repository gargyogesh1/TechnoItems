...
import RelatedPost from "@/components/Software/Blog/RelatedPost";
import SharePost from "@/components/Software/Blog/SharePost";
import TagButton from "@/components/Software/Blog/TagButton";
import NewsLatterBox from "@/components/Software/Contact/NewsLatterBox";
...
const BlogSidebarPage = () => {
    ...
    const fetchBlog = async () => {
      try {
        ...
        const relatedRes = await fetch(
          ...
          "https://technoitemsbackend.onrender.com/api/blogs"
        );
        const allBlogs: Blog[] = await relatedRes.json();

        const related = allBlogs.filter(
          (b) => data.relatedPosts?.includes(b.id)
        );
  ...
  if (loading) {
    return (
      <>
        <Navbar />
        <div className="pt-[180px] text-center">Loading blog...</div>
        <Footer />
      </>
    );
  }
  ...
  return (
    ...
    <Navbar></Navbar>
      ...
      <Helmet>
        ...
        <link
          rel="canonical"
          href={`https://yourdomain.com/TechnoItem/blog-sidebar/${blog.slug}`}
        />
        ...
        <meta
          ...
          content="Read blog details with sidebar and related posts"
        />
        <meta
          name="twitter:image"
          content="https://yourdomain.com/images/blog/blog-details-01.jpg"
        />
      </Helmet>
        ...
        <div className="container">
          <div className="-mx-4 flex flex-wrap">
            <div className="w-full px-4 lg:w-8/12">
              <div>
                <h1 className="yogesh mb-8 text-3xl leading-tight font-bold text-black sm:text-4xl sm:leading-tight dark:text-white">
                  {blog.title}
                </h1>
                  ...
                  <div className="flex flex-wrap items-center">
                    <div className="mr-10 mb-5 flex items-center">
                      ...
                      <div className="w-full">
                        <span className="TechnoItems text-body-color mb-1 text-base font-medium">
                          By <span> {blog.author.name}</span>
                        </span>
                      </div>
                    </div>
                    <div className="mb-5 flex items-center">
                      <p className="TechnoItems text-body-color mr-5 flex items-center text-base font-medium">
                        <span className="mr-3">
                          <svg
                            width="15"
                            height="15"
                      ...
                      <p className="TechnoItems text-body-color flex items-center text-base font-medium">
                        <span className="mr-3">
                          <svg
                            width="20"
                            height="12"
                ...
                <div>
                  <p className="TechnoItems text-body-color mb-10 text-base leading-relaxed font-medium sm:text-lg sm:leading-relaxed lg:text-base lg:leading-relaxed xl:text-lg xl:leading-relaxed">
                    {blog.intro}
                  </p>
                  ...
                  {blog.sections.map((section, index) => (
                    <div key={index} className="mb-10">
                      {/* ✅ Heading */}
                      <h3 className="TechnoItems font-xl mb-10 leading-tight font-bold text-black sm:text-2xl sm:leading-tight lg:text-xl lg:leading-tight xl:text-2xl xl:leading-tight dark:text-white">
                        {section.heading}
                      </h3>

                      {/* ✅ Paragraph Content */}
                      {section.content && (
                        <p className="TechnoItems text-body-color mb-8 text-base leading-relaxed font-medium sm:text-lg sm:leading-relaxed lg:text-base lg:leading-relaxed xl:text-lg xl:leading-relaxed">
                          {section.content}
                        </p>
                      )}
                      ...
                      {section.bulletPoints && (
                        <ul className="TechnoItems text-body-color mb-10 list-inside list-disc">
            ...
            <div className="w-full px-4 lg:w-4/12">
              ...
              <div
                ...
                className="shadow-three dark:bg-gray-dark mb-10 rounded-xs bg-white dark:shadow-none"
              >
                <h3 className="yogesh border-body-color/10 border-b px-8 py-4 text-lg font-semibold text-black dark:border-white/10 dark:text-white">
                  Related Posts
                </h3>

                <ul className="p-8">
                  {loadingRelated && <p>Loading related posts...</p>}
                  ...
                  {relatedBlogs.map((related, index) => (
                    ...
                    >
                      <RelatedPost
                        ...
                        slug={`/blog-sidebar/${related.slug}`}
                        date={related.publishDate}
                      />
                    </li>
                  ))}
                </ul>
              ...
              <div style={{backgroundColor: "var(--color-dark)" }} className="shadow-three dark:bg-gray-dark mb-10 rounded-xs bg-white dark:shadow-none">
                <h3 className="yogesh border-body-color/10 border-b px-8 py-4 text-lg font-semibold text-black dark:border-white/10 dark:text-white">
                  Popular Category
                </h3>
                <ul className="TechnoItems px-8 py-6">
                  <li>
                    <a
                      href="#0"
