...
const ErrorPage = () => {
  return (
    ...
    <Navbar></Navbar>
      <Helmet>
      <title>Error Page | Techno Items Software developer and digitlal marketing</title>

      <meta
        name="description"
        content="This is Error Page for Startup React Template"
      />

      {/* Optional but recommended */}
      <link
        rel="canonical"
        href="https://yourdomain.com/TechnoItem/404"
      />
