        ...
        <div className="-mx-4 flex flex-wrap">
          <div className="w-full px-4 lg:w-7/12 xl:w-8/12">
            <div style={{backgroundColor: "var(--color-dark)" }}
              ...
              "
            >
              <h2 className="yogesh mb-3 text-2xl font-bold text-black dark:text-white sm:text-3xl lg:text-2xl xl:text-3xl">
                Need Help? Open a Ticket
              </h2>
              <p className="TechnoItems mb-12 text-base font-medium text-body-color">
