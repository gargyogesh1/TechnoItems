...
const NewsLatterBox = () => {
  ...
  return (
    <div style={{backgroundColor: "var(--color-dark)" }} className="shadow-three dark:bg-gray-dark relative z-10 rounded-xs bg-white p-8 sm:p-11 lg:p-8 xl:p-11">
      <h3 className="yogesh mb-4 text-2xl leading-tight font-bold text-black dark:text-white">
        Subscribe to receive future updates
      </h3>
      <p className="TechnoItems border-body-color/25 text-body-color mb-11 border-b pb-11 text-base leading-relaxed dark:border-white/25">
        Subscribe to receive updates about our software solutions, AI innovations, product launches, and technology insights tailored to help your business grow.
      </p>
      <div>
        <input
          type="text"
        ...
        />
        <p className="TechnoItems text-body-color dark:text-body-color-dark text-center text-base leading-relaxed">
