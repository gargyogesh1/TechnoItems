const PricingBox = (props: {
  ...
  return (
    <div className="w-full">
      <div style={{backgroundColor: "var(--color-dark)" }} className="shadow-three hover:shadow-one dark:bg-gray-dark dark:shadow-two dark:hover:shadow-gray-dark relative z-10 rounded-xs bg-white px-8 py-10">
        <div className="flex items-center justify-between">
          <h3 className="yogesh price mb-2 text-[32px] font-bold text-black dark:text-white">
