  ...
  return (
    <section className="pt-16">
      <div className="container">
        <div className="-mx-4 flex flex-wrap rounded-[30px] bg-[#e3dcdc3d]">
...
const SingleBrand = ({ brand }: { brand: Brand }) => {
  ...
  return (
    <div className=" flex w-1/2 items-center justify-center px-3 py-[15px] sm:w-1/2 md:w-1/3 lg:w-1/4 xl:w-1/6">
      ...
      >
        <img src={imageLight} alt={name}  className="yogesh hidden dark:block" />
        <img src={image} alt={name}  className="yogesh block dark:hidden" />
      </a>
    </div>
  );
};
