...
const Testimonials = () => {
  ...
  return (
    <section style={{backgroundColor: "rgb(18 20 28 / var(--tw-bg-opacity, 1))" }} id="testimonials" className="py-24 bg-gradient-to-b from-crypto-blue to-[#12141C]">
      <div className="container mx-auto px-4">
        <div className="text-center mb-16">
          ...
          <p className="text-gray-400 max-w-2xl mx-auto">
            Trusted by startups, businesses, and enterprises for delivering reliable, scalable, and innovative digital solutions.
          </p>
        </div>
